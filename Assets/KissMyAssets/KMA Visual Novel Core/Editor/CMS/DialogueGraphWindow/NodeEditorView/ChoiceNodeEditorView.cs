...
{
    /// <summary>
    /// Editor view for a Dialogue Choice Node (<see cref="DialogueChoiceNodeData"/>).
    /// This view is responsible for drawing the node window, handling background selection,
    /// and managing the list of choice options (text and connections).
    /// </summary>
    public class ChoiceNodeEditorView : BaseNodeEditorView
    {
        private readonly DialogueChoiceNodeData _data;
        ...
        public ChoiceNodeEditorView(BaseDialogueNodeData data, INodeConnectionController connectionController) : base(data, connectionController)
        {
            _data = data as DialogueChoiceNodeData;
